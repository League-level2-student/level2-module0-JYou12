...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		JOptionPane.showMessageDialog(null, "A button will show the text 'ME' for a second. Click on the Button. To make the game harder enter a bigger number");
		//13. initialize the hiddenButton variable to a random number less than the int created in step 3
		Random rand = new Random();
		hiddenButton = rand.nextInt(i);
